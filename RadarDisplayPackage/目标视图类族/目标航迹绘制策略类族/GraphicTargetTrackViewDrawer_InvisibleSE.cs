...
{
    class GraphicTargetTrackViewDrawer_InvisibleSE : GraphicTargetTrackViewDrawer_Invisible
    {
        public GraphicTargetTrackViewDrawer_InvisibleSE(CoordinateTargetTrackView view) : base(view) { }
